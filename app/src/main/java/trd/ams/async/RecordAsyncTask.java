...
public class RecordAsyncTask extends AsyncTask {
    ...
    Globals globals;
    String status = "";
    String assetType, assetId,date,scheduleType;
    String FILE = Environment.getExternalStorageDirectory()
            + "/Progress.pdf";
    String url;


    String TAG = "RecordAsyncTask";

public  RecordAsyncTask(Activity activity,android.content.Context context){
    Log.d(TAG, "RecordAsyncTask**");
    ...
    private String syncRecord(Boolean setup){
        ...
        try{
            ...
            Request request = new Request.Builder().url(recordUrl).post(requestBody).build();
         //  Request request = new Request.Builder().url(Constants.ASSET_SCHEDULE_RECORD_URL).post(requestBody).build();
