...
public class AtdPohActivity extends TitleBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AtdPohActivity.this,ReportsActivity.class));
        ...
        ivForward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AtdPohActivity.this,IsolatorAohActivity.class));
            }
        });

        ArrayList<BarEntry> entries = new ArrayList<>();
        entries.add(new BarEntry(265f, 0));
        entries.add(new BarEntry(55f, 1));
        entries.add(new BarEntry(39f, 2));
        entries.add(new BarEntry(25f, 3));
        entries.add(new BarEntry(64f, 4));
        entries.add(new BarEntry(5f, 5));



        BarDataSet dataset = new BarDataSet(entries, "ATD-POH");
