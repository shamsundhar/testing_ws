...
public class ProgressTableActivity extends TitleBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProgress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    public void run(){
                    progressAsync = new ProgressAsyncTask(ProgressTableActivity.this,getApplicationContext());
      ...
      /*  //SimpleDateFormat date = new SimpleDateFormat("dd/MM/yyyy");
        ...
        dbhelper = DatabaseHelper.getInstance(ProgressTableActivity.this);
