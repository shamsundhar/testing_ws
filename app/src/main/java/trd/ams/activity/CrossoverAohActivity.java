...
public class CrossoverAohActivity extends TitleBarActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ivBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(CrossoverAohActivity.this,ReportsActivity.class));
            ...
            ivForward.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(CrossoverAohActivity.this,TurnoutAohActivity.class));
                }
            });
            ...
            entries.add(new BarEntry(71f, 4));
            entries.add(new BarEntry(2f, 5));



            BarDataSet dataset = new BarDataSet(entries, "CROSSOVER-AOH");
