...
public class IolAohActivity extends TitleBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(IolAohActivity.this,ReportsActivity.class));
        ...
        ivForward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(IolAohActivity.this,UiolAohActivity.class));
            }
        });
        ...
        BarDataSet dataset = new BarDataSet(entries, "IOL-AOH");
