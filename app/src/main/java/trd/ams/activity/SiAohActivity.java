...
public class SiAohActivity extends TitleBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SiAohActivity.this,ReportsActivity.class));
        ...
        ivForward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SiAohActivity.this,IolAohActivity.class));
            }
        });

        ArrayList<BarEntry> entries = new ArrayList<>();
        entries.add(new BarEntry(56f, 0));
        entries.add(new BarEntry(50f, 1));
        entries.add(new BarEntry(35f, 2));
        entries.add(new BarEntry(24f, 3));
        entries.add(new BarEntry(69f, 4));
        entries.add(new BarEntry(0f, 5));



        BarDataSet dataset = new BarDataSet(entries, "SI-AOH");
