...
public class IsolatorAohActivity extends TitleBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(IsolatorAohActivity.this,ReportsActivity.class));
        ...
        ivForward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(IsolatorAohActivity.this,SiAohActivity.class));
            }
        });

        ArrayList<BarEntry> entries = new ArrayList<>();
        entries.add(new BarEntry(42f, 0));
        entries.add(new BarEntry(42f, 1));
        entries.add(new BarEntry(29f, 2));
        entries.add(new BarEntry(21f, 3));
        entries.add(new BarEntry(72f, 4));
        entries.add(new BarEntry(2f, 5));



        BarDataSet dataset = new BarDataSet(entries, "ISOLATOR-AOH");
